...
class Notlardao{
  ...
  Future<List<Notlar>> searchKelime(String aramaKelimesi) async {
      var db = await VeritabaniYardimcisi.veritabaniErisim();

      List<Map<String,dynamic>> maps = await db.rawQuery("SELECT * FROM notlar WHERE ders_adi like '%$aramaKelimesi%'");
